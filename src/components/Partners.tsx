...
const Features: NextPage = () => {
    return (
        <section className="dark:text-gray-100">
            ...
            <div className="  leading-24 mx-4 mt-24 text-center text-4xl font-light text-white md:mx-0 md:text-5xl">
        ...
        <img src="/injective-logo.svg" alt="Vector 3" /> */}
            ...
            <div className="  text-18 leading-24 mx-4 mt-16 text-center font-light text-white md:mx-0">
            ...
            <div className="mt-8 flex flex-col items-center justify-center space-y-8 md:flex-row md:space-y-0 md:space-x-10">
                ...
                >
                    <span className="text-18   mr-2">Join Discord</span>
                    <svg
                        width="30"
                        height="30"
                        viewBox="0 0 30 30"
            ...
            <div className="  text-18 leading-24 mt-8 text-center font-light text-white">
                Follow us on
            </div>
