            ...
            <div className="bg-dark-blue text-white ">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-5 gap-2">
                        ...
                        <div className="col-span-3 backdrop-blur-[4px] text-xl rounded-xl p-6"
                            style={{
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mt-12">
                        ...
                        <div className="p-10 text-left backdrop-blur-[4px] rounded-xl"
                            style={{
                                background: 'radial-gradient(ellipse at center top, rgba(23, 58, 63, 0.35) 10%, rgba(4, 20, 32, 0) 100%)',
                                boxShadow: '3.8px 3.8px 38px 0px rgba(70, 70, 70, 0.10) inset',
                            }}>
                    ...
                    <div className="pt-10 px-10 mt-2 text-left backdrop-blur-[4px] rounded-xl"
                        style={{
                            background: 'radial-gradient(ellipse at center top, rgba(23, 58, 63, 0.35) 10%, rgba(4, 20, 32, 0) 100%)',
                            boxShadow: '3.8px 3.8px 38px 0px rgba(70, 70, 70, 0.10) inset',
                        }}>
